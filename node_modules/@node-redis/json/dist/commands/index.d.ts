...
=======
export declare type RedisJSON = null | boolean | number | string | Date | Array<RedisJSON> | {
    [key: string]: RedisJSON;
} | {
    [key: number]: RedisJSON;
};
export declare function transformRedisJsonArgument(json: RedisJSON): string;
export declare function transformRedisJsonReply(json: string): RedisJSON;
export declare function transformRedisJsonArrayReply(jsons: Array<string>): Array<RedisJSON>;
export declare function transformRedisJsonNullReply(json: string | null): RedisJSON | null;
export declare function transformRedisJsonNullArrayNullReply(jsons: Array<string | null> | null): Array<RedisJSON | null> | null;
